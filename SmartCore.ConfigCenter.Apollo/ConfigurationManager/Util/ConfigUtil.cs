using SmartCore.ConfigCenter.Apollo.ConfigurationManager.Core;
using SmartCore.ConfigCenter.Apollo.Core;
using SmartCore.ConfigCenter.Apollo.Enums;
using SmartCore.ConfigCenter.Apollo.Foundation;
using System;
...
namespace SmartCore.ConfigCenter.Apollo.ConfigurationManager.Util
{
    public class ConfigUtil : IApolloOptions
    {
        ...
        public static string? GetAppConfig(string key)
        {
            ...
            var appSettings = AppSettings ?? System.Configuration.ConfigurationManager.AppSettings;
