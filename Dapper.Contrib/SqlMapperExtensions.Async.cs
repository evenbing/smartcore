...
namespace Dapper.Contrib.Extensions
{
    public static partial class SqlMapperExtensions
    {
        ...
        /// <returns></returns>
        public static async Task<Tuple<IEnumerable<T>,int>> GetListByPageAsync<T>(this IDbConnection connection, PageModel pageModel, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            ...
            int totalCount;
            using (var reader =await connection.QueryMultipleAsync(sql, pageModel.DynamicParam, transaction, commandTimeout).ConfigureAwait(false))
            {
                totalCount = reader.ReadFirst<int>(); 
                var result= reader.Read<T>();
                return new Tuple<IEnumerable<T>, int>(result, totalCount);
            }
        }
        ...
        /// <param name="commandTimeout"></param>
        /// <returns></returns>
        public static async Task<Tuple<IEnumerable<T>, int>> GetListByPageAsync<T>(this IDbConnection connection,string sql, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            int totalCount;
            using (var reader = await connection.QueryMultipleAsync(sql, sql, transaction, commandTimeout).ConfigureAwait(false))
            {
                totalCount = reader.ReadFirst<int>();
                var result = reader.Read<T>();
                return new Tuple<IEnumerable<T>, int>(result, totalCount);
