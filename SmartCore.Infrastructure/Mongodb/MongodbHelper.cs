...
namespace SmartCore.Infrastructure.Mongodb
{
    ...
    public static class MongodbHelper<T> where T : class, new()
    {
        ...
        /// <param name="dbConfig">mongodb连接信息</param>
        /// <returns></returns>
        public static int Add(MongodbConfig dbConfig, T t)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
                client.InsertOne(t);
                return 1;
            }
            catch
        ...
        /// <param name="dbConfig">mongodb连接信息</param>
        /// <returns></returns>
        public static async Task<int> AddAsync(MongodbConfig dbConfig, T t)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <returns></returns>
        public static int InsertMany(MongodbConfig dbConfig, List<T> t)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="t">实体集合</param>
        /// <returns></returns>
        public static async Task<int> InsertManyAsync(MongodbConfig dbConfig, List<T> t)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="dbConfig">mongodb连接信息</param>
        /// <returns></returns>
        public static UpdateResult Update(MongodbConfig dbConfig, T t, string id)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="dbConfig">mongodb连接信息</param>
        /// <returns></returns>
        public static async Task<UpdateResult> UpdateAsync(MongodbConfig dbConfig, T t, string id)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <returns></returns>
        public static UpdateResult UpdateManay(MongodbConfig dbConfig, Dictionary<string, string> dic, FilterDefinition<T> filter)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="filter">修改条件</param>
        /// <returns></returns>
        public static async Task<UpdateResult> UpdateManayAsync(MongodbConfig dbConfig, Dictionary<string, string> dic, FilterDefinition<T> filter)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <returns></returns>
        public static DeleteResult Delete(MongodbConfig dbConfig, string id)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="id">objectId</param>
        /// <returns></returns>
        public static async Task<DeleteResult> DeleteAsync(MongodbConfig dbConfig, string id)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <returns></returns>
        public static DeleteResult DeleteMany(MongodbConfig dbConfig, FilterDefinition<T> filter)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="filter">删除的条件</param>
        /// <returns></returns>
        public static async Task<DeleteResult> DeleteManyAsync(MongodbConfig dbConfig, FilterDefinition<T> filter)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <returns></returns>
        public static long Count(MongodbConfig dbConfig, FilterDefinition<T> filter)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="filter">条件</param>
        /// <returns></returns>
        public static async Task<long> CountAsync(MongodbConfig dbConfig, FilterDefinition<T> filter)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <returns></returns>
        public static T FindOne(MongodbConfig dbConfig, string id, string[] field = null)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="id">objectid</param>
        /// <returns></returns>
        public static async Task<T> FindOneAsync(MongodbConfig dbConfig, string id, string[] field = null)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <returns></returns>
        public static List<T> FindList(MongodbConfig dbConfig, FilterDefinition<T> filter, string[] field = null, SortDefinition<T> sort = null)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="sort">要排序的字段</param>
        /// <returns></returns>
        public static async Task<List<T>> FindListAsync(MongodbConfig dbConfig, FilterDefinition<T> filter, string[] field = null, SortDefinition<T> sort = null)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="sort">要排序的字段</param>
        /// <returns></returns>
        public static List<T> FindListByPage(MongodbConfig dbConfig, FilterDefinition<T> filter, int pageIndex, int pageSize, out long count, string[] field = null, SortDefinition<T> sort = null)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
        ...
        /// <param name="sort">要排序的字段</param>
        /// <returns></returns>
        public static async Task<List<T>> FindListByPageAsync(MongodbConfig dbConfig, FilterDefinition<T> filter, int pageIndex, int pageSize, string[] field = null, SortDefinition<T> sort = null)
        {
            try
            {
                var client = MongodbClient<T>.MongodbInfoClient(dbConfig);
